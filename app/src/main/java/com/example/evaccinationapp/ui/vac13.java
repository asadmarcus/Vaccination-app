...
public class vac13 extends AppCompatActivity {

    Button btn_dose1, btn_dose2;
    TextView tv_numOfDays;
    SharedPreferences sharedpreferences;
    public static final String MyPREFERENCES = "vac13";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vac13);
        ...
        btn_dose1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString(numOfDays, "3 yrs");
                editor.commit();
                fillUi();
            }
        });
